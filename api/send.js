// api/webhook.js - 24/7 Telegram Bot Webhook Handler for Vercel
const BOT_TOKEN = "8693779636:AAHIeQCUgS7bvwrArl6otipy8wyifOgz8rU"; // আপনার বট টোকেন
const OWNER_ID = "7209869264"; // আপনার আইডি
...
// Helper: Bold Capital Text Converter
...
export default async function handler(req, res) {
  if (req.method !== "POST") {
    return res.status(200).send("Telegram 24/7 Webhook is Active!");
  }

  const update = req.body;
  if (!update) return res.status(200).send("OK");

  // ১. সাধারণ টেক্সট মেসেজ ও /start হ্যান্ডলিং
  if (update.message) {
    ...
    if (text.startsWith("/start")) {
      ...
      await callTelegram("sendMessage", {
        chat_id: chatId,
        text: "ℹ️ <b>সাহায্য ও সাপোর্টের জন্য যোগাযোগ করুন:</b> @sn_support_admin",
        parse_mode: "HTML"
      });
    }
  }

  // ২. ইনলাইন বাটন ক্লিক (Callback Queries) হ্যান্ডলিং
  if (update.callback_query) {
    ...
    // বাটন ক্লিক অ্যানিমেশন বন্ধ করা
    ...
    if (data === "/profile") {
      ...
      await callTelegram("answerCallbackQuery", {
        ...
        text: "⚡ এই ফিচারটি শীঘ্রই চালু হবে!",
        show_alert: true
      });
    }
  }
